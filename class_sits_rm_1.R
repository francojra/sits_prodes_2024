...
# Tiles: 037011, 037012, 037013, 039012, 039013, 039014, 040012, 040013, 040014 --------------------------------------------------------------------------------------------
...
cubo_rm1 <- sits_cube(
  ...
  tiles      = c("037011", "037012", "037013", "039012", 
                 "039013", "039014", "040012", "040013", 
                 "040014"), # Tiles/Regiões de ineteresse
...
sits_bands(cubo_rm1)
sits_timeline(cubo_rm1)
view(cubo_rm1)
view(cubo_rm1$file_info)

## Salvar e ler cubo criado

saveRDS(cubo_rm1, file = "cubo_rm1.rds") 
cubo_rm1 <- readRDS("cubo_rm1.rds")

# Ler arquivo .shp com amostras por classes ---------------------------------------------------------------------------------------------------------------

amostras_classes <- sf::read_sf("Amostras_originais_RM1.shp")
...
cubo_amostras_rm1 <- sits_get_data(
  cubo_rm1, 
  samples = amostras_classes, # Arquivo shapefile 
