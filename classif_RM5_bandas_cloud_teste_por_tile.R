...
crs(amostras_classes)
crs(cubo[1, ]$crs)

# Tornar tabela de amostras para o CRS dos tiles 

amostras_classes <- sf::st_transform(amostras_classes, sf::st_crs(cubo$crs[1]))
...
cubo_amostras <- sits_get_data(
  ...
  memsize = 5, # consumo de memória
  multicores = 4, # Número de núcleos usados. Quanto maior, mais rápido o processamento
